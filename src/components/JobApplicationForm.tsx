...
export function JobApplicationForm({ onAdd }: JobApplicationFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="bg-white dark:bg-zinc-900 p-6 rounded-lg shadow-sm border border-zinc-200 dark:border-zinc-800 space-y-4">
      <h2 className="text-xl font-semibold text-zinc-900 dark:text-zinc-50 mb-4">Add Application</h2>
